...
const ClientsComponent = () => {
  return (
    <div
      id="clients"
      className="text-center border rounded-lg overflow-hidden w-full max-w-md sm:max-w-xl lg:max-w-5xl mx-auto"
    >
      {/* Clients */}
      <div className="px-4 py-6 sm:px-6 lg:px-8 lg:py-10 mx-auto">
        {/* Title */}
        <div className="w-2/3 sm:w-1/2 lg:w-1/3 mx-auto text-center mb-4">
          <h2 className="text-gray-600 dark:text-gray-400 text-lg sm:text-xl lg:text-2xl font-semibold">
            Trusted by:
          </h2>
        </div>
        {/* End Title */}
        ...
        {/* End Grid */}
        {/* Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-6 sm:gap-x-6 place-items-center justify-items-center">
          <svg
            className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto text-gray-500"
            xmlns="http://www.w3.org/2000/svg"
            x={0}
